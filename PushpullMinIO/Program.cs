...
namespace FileLoader
{
    class FileLoad
    {
        static void Main(string[] args)
        {
            ...
            {
                // Set file to download here
                FileLoad.Remove(minio, "myfirstbucket", // bucket name
                                              "test1-1.txt" // name of a file in server
                                              ).Wait();
            }
            catch (Exception ex)
        ...
        public static async Task Remove(IMinioClient minio,
        string bucketName,
        string objectName,
        IServerSideEncryption sse = null) // Idk what is this
        {
            try
            {
                ...
                Console.WriteLine($"{objectName} was successfully removed from bucket {bucketName}");
                Console.WriteLine();
            }
            catch (Exception e)
            {
